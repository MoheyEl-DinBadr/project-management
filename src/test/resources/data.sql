...
-- INSERT PROJECTS			
insert into project (project_id, name, stage, description, start_date, end_date) values (nextval('project_seq'), 'Large Production Deploy', 'NOTSTARTED', 'This requires all hands on deck for the final deployment of the software into production', '2015-12-17', '2018-12-17');
insert into project (project_id, name, stage, description, start_date, end_date) values (nextval('project_seq'), 'New Employee Budget',  'COMPLETED', 'Decide on a new employee bonus budget for the year and figureout who will be promoted', '2017-01-23', '2018-11-20');
insert into project (project_id, name, stage, description, start_date, end_date) values (nextval('project_seq'), 'Office Reconstruction', 'INPROGRESS', 'The office building in Monroe has been damaged due to hurricane in the region. This needs to be reconstructed', '2011-12-17', '2020-12-17');
insert into project (project_id, name, stage, description, start_date, end_date) values (nextval('project_seq'), 'Improve Intranet Security', 'INPROGRESS', 'With the recent data hack, the office security needs to be improved and proper security team needs to be hired for implementation', '2021-12-17', '2022-12-17');
